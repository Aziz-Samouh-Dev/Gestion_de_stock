    ...
    <aside id="logo-sidebar "
        ...
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
            <a href="{{ url('produits') }}" class="flex items-center justify-center mb-3">
                <div class="p-2">
                    <img src="/images/1.png" alt="logo" class="w-20 md:w-40">
                </div>
            </a>
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <a href="{{ url('divisions') }}"
                        ...
                        <span class="flex-1 ml-3 whitespace-nowrap">Divisions</span>
                    </a>
                </li>
                <li>
    ...
    <div class="relative inset-x-0 bottom-0 sm:ml-64 bg-gray-200">
        <footer class="sticky buttom-0 right-0 p-4 bg-white shadow dark:bg-gray-800">
            ...
            <span class="block text-center text-gray-500 sm:text-center dark:text-gray-400">
                Copyright © {{ date('Y') }}
                <a href="https://github.com/hassan1samouh/Gestion_de_stock1.git" target="_blank" class="hover:underline">
                    Agence Name
                </a>
                .
            </span>
