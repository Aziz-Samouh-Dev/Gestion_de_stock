            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg px-3">
                <div class="flex items-center justify-center mb-5 ">
                    <div class=" w-full p-3 ">
                        <div class=" px-4 ">
                            <h1 class="text-2xl font-bold antialiased pb-3 pt-6 text-green-600">Produit info</h1>
                        </div>
                        <div class="p-6 bg-white border border-gray-200 rounded-lg shadowdark:bg-gray-800 ">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">Nom : {{ $agents->nom_agent }} </h5>
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">Prenom : {{ $agents->prenom_agent }} </h5>
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 ">Grade : {{ $agents->grade_agent }} </h5>
                        </div>
