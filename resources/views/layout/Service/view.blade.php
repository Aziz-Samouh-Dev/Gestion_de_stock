...
@section('title', 'Informations sur le Service')
                    ...
                    <div class="p-6 bg-white border border-gray-200 rounded-lg shadowdark:bg-gray-800 ">
                        <dl class="max-w-md text-gray-900 divide-y divide-gray-200 ">
                            <div class="flex flex-col pb-3">
                                <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Service Name:</dt>
                                <dd class="text-lg font-semibold">
                                    {{ $service->nom_service }}
                                </dd>
                            </div>
                            <div class="flex flex-col py-3">
                                <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400">Agents:</dt>
                                <dd class="text-lg font-semibold">
