        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg px-3">
            <div class="flex items-center justify-center mb-5 ">
                <div class="w-full p-3">
                    <div class="px-4">
                        <h1 class="text-2xl font-bold antialiased pb-3 pt-6 text-green-600">Liste divisions</h1>
                    </div>
                                ...
                                @foreach ($divisions as $division)
                                    <tr class="bg-white border-b ">
                                        ...
                                        <td class="px-6 py-3 flex items-center ">
                                            ...
                                            <form method="post" action="{{ url('/divisions/' . $division->id_division) }}">
                                                @csrf
                                                {{ method_field('DELETE') }}
                                                <button type="submit" title="Delete division"
