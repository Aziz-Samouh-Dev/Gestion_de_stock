            ...
            <div class="flex items-center justify-center mb-5">
                <div class="w-full p-3">
                    ...
                    <div class="px-6 py-3 flex justify-end">
                        <a href="{{ url('/divisions/' . $division->id_division) . '/edit' }}" title="View service">
                            <button type="button"
                        ...
                        <form method="post" action="{{ url('/divisions/' . $division->id_division) }}"
                            id="delete-form-{{ $division->id_division }}">
                            @csrf
                            {{ method_field('DELETE') }}
                            <button type="submit" title="Delete service"
                                onclick="return confirm('Confirm delete?')"
                                form="delete-form-{{ $division->id_division }}"
