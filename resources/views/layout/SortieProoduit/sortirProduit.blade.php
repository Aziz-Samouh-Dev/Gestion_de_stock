            ...
            <div class="relative overflow-x-auto  p-3 grid   ">
                ...
                <div class=" flex flex-wrap">
                    <div class="w-full px-3 grid grid-cols-3 gap-4 ">
                        <div class="mb-5">
                            <label for="division" class="pl-3 mb-3 block text-base font-medium text-[#07074D]">
                                Nom Division
                            </label>
                        ...
                        <div class="mb-5">
                            <label for="service" class="pl-3 mb-3 block text-base font-medium text-[#07074D]">
                                Nom Service
                            </label>
                        ...
                        <div class="mb-5">
                            <label for="agent" class="pl-3 mb-3 block text-base font-medium text-[#07074D]">
                                Nom Agents
                            </label>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#division').on('change', function() {
                ...
                if (divisionId !== '') {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            serviceSelect.append($('<option></option>').attr('selected',
                                'selected').text('Select...').addClass('hidden'));
                            $.each(data, function(key, value) {
                                serviceSelect.append($('<option></option>').attr(
                                    'value', value.id_service).text(value
                                    .nom_service));
                            });
                ...
                var divisionName = this.selectedOptions[0].text;
                document.getElementById('divisionName').innerText = divisionName;
            });
                ...
                if (serviceId !== '') {
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            agentSelect.append($('<option></option>').attr('selected',
                                'selected').text('Select...').addClass('hidden'));
                            $.each(data, function(key, value) {
                                agentSelect.append($('<option></option>').attr('value',
                                    value.id_agent).text(value.nom_agent));
                            });
                        }
                    });
                } else {
